...
const WELCOME =
  "Hello! I'm here to help you find health insurance and benefit programs for your household.\n\nI'll ask a few questions to understand your situation — no account needed, and your information stays private.\n\nLet's start with some basics.";
